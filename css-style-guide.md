...
CSS指层叠样式表 (Cascading Style Sheets)，是网页样式语言。任何网页都离不开CSS样式，作为前端开发工程师也必须要掌握的编程语言，使得在开发过程中，你能随意的更改样式和做页面UI调整，增强界面体验等。 CSS语言掌握情况[测试][1]，基础[教程][2]

本编码规范目的是使开发人员编写的CSS代码风格保持一致，容易被理解和维护。
  [1]: http://www.w3school.com.cn/quiz/quiz.asp?quiz=css
  [2]: http://www.w3school.com.cn/css/css_intro.asp
...
**说明：以上2.2——2.6 的要求可以通过IDE美化CSS达到。推荐`sublime`或者`webstrom`**
